                        ...
                        <div class="code-block-header">
                            ...
                            <div class="code-block-actions">
                                <div class="code-action-item" onclick="_fd_copyCode('${blockId}')">
                                    ...
                                    <span class="code-action-text">${this.t(
        'props.copy'
    )}</span>
                                </div>
                                ${
            ...
            try {
                ...
                if (diffData.oldJson && diffData.newJson) {
                    ...
                    const lineDiff = generateLineDiff(
                        JSON.parse(diffData.oldJson),
                        JSON.parse(diffData.newJson)
                    );
                    ...
                    html += `
                        <div class="${lineClass}">
                            ...
                            <div class="diff-line-content">
                                <div class="diff-same-line">${this.escapeHtml(
        line.oldLine
    )}</div>
                            </div>
                        </div>
                    ...
                    html += `
                        <div class="${lineClass}">
                            ...
                            <div class="diff-line-content">
                                ${
    line.oldLine
        ? `<div class="diff-old-line">${this.escapeHtml(
            line.oldLine
        )}</div>`
        : ''
}
                                ${
    line.newLine
        ? `<div class="diff-new-line">${this.escapeHtml(
            line.newLine
        )}</div>`
        : ''
}
